...
apiRequestList.onreadystatechange = () => {
  if (apiRequestList.readyState === 4) {
    ...
    if (firstDigit == 4) {
      window.location.href = "https://orinco.netlify.app/pages/error-page-404.html"

    } else if (firstDigit == 5) {
      window.location.href = "https://orinco.netlify.app/pages/error-page-500.html"
    ...
    // Handle API Response  
      ...
      response.forEach((item, index) => {
        ...
        buttons[index].setAttribute('href', `https://orinco.netlify.app/pages/single-item.html?id=${id}`);
      }) 
    }
  }
};
